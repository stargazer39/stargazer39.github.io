...
! function(a, b) {
    ...
    function m(a) {
        ...
        function h(a, c) {
            ...
            }), m.removeClass("lity-loading").find(".lity-content").empty().append(p), p.removeClass("lity-hide").trigger("lity:ready", [m, a]), t.resolve())
        }
        ...
        function j(a, c, d) {
            ...
            if (c = b.extend({}, w, r, c), c.handler && g[c.handler]) f = g[c.handler](a, l), e = c.handler;
            else {
                var h = {};
            ...
            return f && (t = b.Deferred(), b.when(k()).done(b.proxy(i, null, e, f, c, d))), !!f
        }
    ...
    return m.version = "1.6.0", m.handlers = b.proxy(e, m, v), m.options = b.proxy(e, m, w), b(n).on("click", "[data-lity]", m()), m
});